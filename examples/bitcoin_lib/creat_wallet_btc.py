...
wallet_P2PKH = Wallet.create('WalletLegacy', network='bitcoin', witness_type='legacy')
key_P2PKH = wallet_P2PKH.get_key()

# Creat Segwit (P2WPKH) Address
wallet_P2WPKH = Wallet.create('WalletSegwit', network='bitcoin', witness_type='segwit')
key_P2WPKH = wallet_P2WPKH.get_key()

# Creat Script (P2SH)
wallet_P2SH = Wallet.create('WalletScript', network='bitcoin', witness_type='p2sh-segwit')
